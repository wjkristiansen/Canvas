...
void DumpNode(XSceneGraphNode *pNode, const std::wstring &indent)
{
    ...
    // Dump children
    TGomPtr<XIterator> pChildIterator;
    if (Succeeded(pNode->CreateChildIterator(&pChildIterator)))
    {
        ...
        {
            TGomPtr<XSceneGraphNode> pChildNode;
