...
public:
    ...
    GEMMETHOD(CreateCanvasGfx)(PCSTR szDLLPath, _Outptr_opt_result_nullonfailure_ XCanvasGfx **ppCanvasGfx) final;
...
typedef Result (*CreateCanvasGfxProc)(_Outptr_opt_result_nullonfailure_ XCanvasGfx **pGraphicsGfx, QLog::CLogClient *pLogClient);
